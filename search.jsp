...
<script type="text/javascript">
	$(function(){		
		...
		$(window).scroll(function(){
			  //var scrollTo = $(window).scrollTop();//스크롤바 높이
			  //var docHeight = $(document).height();//내가쓴문서의 높이
			  //var windowHeight = $(window).height();//윈도우의높이
...
<form method="get">
	<div id="wrapper">
		...
		<div id="TitleImg">
			...
			&nbsp;&nbsp;
			<img src="../images/like.png" alt="좋아요" id="like" /><%=vo.getPt_like() %>
		</div>
		<%}%>
		</div>
		<a href=""><img src="../images/top.png" alt="" id="top" /></a>
	</div>
	</div>
</form>
</body>
